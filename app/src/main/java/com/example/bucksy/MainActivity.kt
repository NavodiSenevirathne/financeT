...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeViews() {
        ...
        sharedPreferences = getSharedPreferences("BucksyPrefs", MODE_PRIVATE)
    ...
    private fun displayPieCharts() {
        ...
        setupPieChart(incomePieChart, incomeByCategory, "Income by Category")
        setupPieChart(expensePieChart, expenseByCategory, "Expense by Category")
    }

    private fun setupPieChart(chart: PieChart, data: Map<String, Double>, label: String) {
        val entries = data.map { (category, value) ->
            PieEntry(value.toFloat(), category)
        }
        ...
        chart.apply {
            ...
            legend.textColor = ContextCompat.getColor(this@MainActivity, R.color.accent_secondary)
